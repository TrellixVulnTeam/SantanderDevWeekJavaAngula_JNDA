package com.projectBootcamp.controller;

import com.projectBootcamp.model.dto.StockDTO;
import com.projectBootcamp.service.StockService;
...
public class StockController {
    ...
    public ResponseEntity<StockDTO> findByid(@PathVariable Long id){
        ...
        StockDTO dtoSelecionado = list.stream().filter(x -> x.getId().compareTo(id) == 0).findFirst().get();
